...
#This program creates the plots needed
...
def plot_energy_vs_alpha(omega):
  ...
  plt.figure("Plot")
  plt.grid(1)
  plt.plot(alpha,pot_e,'#E57375',marker='o',linestyle='dashed',
   markersize='3')
...
def plot_r12_vs_omega(filename,filename2,identifier,identifier2):
  var, pot_e, var_pot_e, kin_e, var_kin_e,pe_wo,var_pe_wo,\
    pe_w,var_pe_w, r12, Accepted =\
  np.loadtxt("results/%s"%(filename), skiprows=2,unpack=True) 
  var1, pot_e1, var_pot_e1, kin_e1, var_kin_e1, pe_wo,var_pe_wo1,\
     pe_w,var_pe_w1, r12_1, Accepted1 =\
...
def plot_var_vs_omega(filename,filename2):
  var, e, var_e, kin_e, var_kin_e,pe_wo,var_pe_wo,\
    pe_w,var_pe_w, r12, Accepted =\
  np.loadtxt("results/%s"%(filename), skiprows=2,unpack=True) 

  var, e, var_e1, kin_e, var_kin_e,pe_wo,var_pe_wo,\
    pe_w,var_pe_w, r12, Accepted =\
  np.loadtxt("results/%s"%(filename2), skiprows=2,unpack=True) 
...
def plot_kin_vs_pot_wo(filename,identifier):
  ...
  plt.figure("Plot")
  plt.grid(1)
  plt.plot(var,kin_e/pe_wo,'#E57375',marker='o',linestyle='dashed',
   markersize='3')
  plt.xlabel("$\omega$",fontsize="14")
  plt.ylabel("$\\frac{\langle T \\rangle}{\langle V \\rangle}$",
  fontsize="14")
...
def plot_kin_vs_pot(filename, filename3):
  ...
  var, e, var_pot_e, kin_e3, var_kin_e3, pe_wo3,var_pe_wo3, pe_w3,\
     var_pe_w3, r12, Accepted =\
