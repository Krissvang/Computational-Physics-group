...
//   x[] contains the random numbers for all dimensions
       //Generate r=r1+r2 according to exponential dist., then "distribute"
       //uniformly between r1 and r2:
       y = ran0(&idum);
       r = -log(1-y);
       x[0] = r*ran0(&idum);
       x[1] = r-x[0];
