...
void initialize(int, string, double, arma::Mat<int>&, double&, double&);
   ...
   double& heatcap, double& M_avg, double& M_abs_avg, double& susc)
{
  ...
  initialize(n_spins, init, temperature, spin_matrix, E, M);
...
void initialize(int n_spins, string init, double temperature,
  Mat<int>& spin_matrix, double& E, double& M)
{
